                            ...
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                ...
                                if ((long) documentSnapshot.get("view_type") == 0) {
                                    ...
                                    for (long x = 1; x < no_of_banners + 1; x++) {
                                        slideModelList.add(new SlideModel(documentSnapshot.get("banner_" + x).toString(), null, ScaleTypes.FIT));
                                    }
                                    lists.get(index).add(new HomePageModel(0, slideModelList));
                                    ...
                                    lists.get(index).add(new HomePageModel(2, horizontalProductScrollModelList, documentSnapshot.get("layout_title").toString(), documentSnapshot.get("layout_background").toString(), viewAllProductList));
                                    ...
                                    lists.get(index).add(new HomePageModel(3, gridLayoutModelList, documentSnapshot.get("layout_title").toString(), documentSnapshot.get("layout_background").toString()));
                                }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    for (long x = 0; x < (long) task.getResult().get("list_size"); x++) {
                        ...
                        if (DBquries.wishList.contains(ProductDetailsActivity.productID)) {
            ...
            firebaseFirestore.collection("USERS").document(FirebaseAuth.getInstance().getUid()).collection("USER_DATA").document("MY_RATINGS")
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (OrdersFragment.myOrderAdapter != null) {
                            OrdersFragment.myOrderAdapter.notifyDataSetChanged();
                        }
                    } else {
                        Toast.makeText(context, "Error :" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    for (long x = 0; x < (long) task.getResult().get("list_size"); x++) {
                        ...
                        if (DBquries.cartList.contains(ProductDetailsActivity.productID)) {
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            if (task.getResult().getDocuments().size() < (Long) documentSnapshot.get("stock_quantity")) {
                                                                cartItemModelList.add(index, new CartItemModel(documentSnapshot.getBoolean("COD"), CartItemModel.CART_ITEM,
                                                                        productId,
                    ...
                    .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                        ...
                        public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                            if (documentSnapshot != null && documentSnapshot.exists()){
                                ...
                                if (NotificationActivity.adaper != null){
                                    NotificationActivity.adaper.notifyDataSetChanged();
                                }
